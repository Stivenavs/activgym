...
$stmtInsert = $pdo->prepare("INSERT INTO ventas (caja_id, producto_id, detalle, cantidad, valor, fecha, hora, payment_method) VALUES (:caja_id, NULL, :detalle, :cantidad, :valor, :fecha, :hora, 'Egreso')");
